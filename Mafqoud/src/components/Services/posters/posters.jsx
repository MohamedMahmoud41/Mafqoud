      ...
      <div className="post" key={index}>
        <div className="poster-content">
          <div className="poster_handel">
            ...
            <div className="poster-details poster-details-myPosts">
          ...
          <div className="loster-photo-container">
            <div className="image-wrapper">
              <img
                src={`https://www.api-3000.mafqoud.site${poster.photos[0]}`}
                alt="loster-img"
                className="loster-photo"
                crossOrigin="anonymous"
                onClick={() =>
                  window.open(
                    `https://www.api-3000.mafqoud.site${poster.photos[0]}`,
                    "_blank"
                  )
                }
              />
            ...
            >
              <div className="main-button">
                ...
                <div className="poster_create_btn">
                  <button
                    className="btn herobtn-1 posts-create-btn"
                    onClick={toggleModal}
                  >
                    Create post
                  </button>
              ...
              <div className="filter">
                <button onClick={handleGetAll} className="filtter-button">
                  All
                </button>
                <select
                  name="ageRange"
                ...
                <button onClick={handleSearch} className="filtter-button">
                  Filter
                </button>
              </div>
            </div>
